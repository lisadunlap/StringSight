...
Configured for HuggingFace Spaces deployment.
"""
...
def create_app(results_dir: str = "results/"):
    ...
    with gr.Blocks(title="Benchmark Results Viewer") as app:
...
if __name__ == "__main__":
    ...
    if app:
        app.launch(share=args.share, server_name="0.0.0.0", server_port=7860, show_error=False)
